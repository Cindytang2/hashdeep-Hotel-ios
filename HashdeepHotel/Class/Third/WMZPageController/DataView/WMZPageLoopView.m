...
- (void)setUp{
    ...
    if (self.param.wInsertMenuLine) {
        CGFloat topY = self.param.wMenuCellMarginY;
        CGFloat bottomY = self.param.wMenuBottomMarginY;
        self.bottomView = [UIView new];
        self.bottomView.backgroundColor = PageColor(0x999999);
        self.bottomView.frame = CGRectMake(0, self.mainView.frame.size.height+topY+bottomY-PageK1px, self.mainView.frame.size.width, PageK1px);
