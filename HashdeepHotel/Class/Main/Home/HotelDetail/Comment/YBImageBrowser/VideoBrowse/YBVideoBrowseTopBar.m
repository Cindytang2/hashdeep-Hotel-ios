...
static CGFloat kTopBarDefaultsHeight = 50.0 + 20;
...
- (void)layoutSubviews {
    ...
    self.cancelButton.frame = CGRectMake(10 + hExtra, self.bounds.size.height - kTopBarDefaultsHeight + YBIB_HEIGHT_STATUSBAR, kTopBarDefaultsHeight, kTopBarDefaultsHeight);
