//
//  HHSelectedRegionTableViewCell.m
//  HashdeepHotel
//
...
@interface HHSelectedRegionTableViewCell ()
@property (nonatomic, strong) UILabel *titleLabel;
@end

@implementation HHSelectedRegionTableViewCell
...
- (void)setModel:(SelectedRegionModel *)model {
    _model = model;
    self.titleLabel.text = _model.city_name;
}
@end
