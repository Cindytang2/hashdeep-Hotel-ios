...
- (UICollectionReusableView *)collectionView:(WMZDropCollectionView *)collectionView viewForSupplementaryElementOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath{
    if (kind == UICollectionElementKindSectionHeader){
        ...
        [headerView.accessTypeBtn setImage:[UIImage bundleImage:@"icon_home_hotel_down"] forState:UIControlStateNormal];
        [headerView.accessTypeBtn setImage:[UIImage bundleImage:@"icon_home_hotel_up"] forState:UIControlStateSelected];
